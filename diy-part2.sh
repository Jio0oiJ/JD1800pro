...
sed -i 's|^PKG_SOURCE_URL:=https://github.com/SoftEtherVPN/SoftEtherVPN_Stable/releases/download/v$(PKG_REALVERSION)-$(PKG_VERREL)|PKG_SOURCE_URL:=https://github.com/Jio0oiJ/softethervpn/releases/download/v$(PKG_REALVERSION)-$(PKG_VERREL)|' Makefile
